      ...
      <section className="text-center py-6">
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-8 max-w-3xl mx-auto transition-all duration-500">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-8">
            <Link href="/resume/en_software.pdf" target="_blank" rel="noopener noreferrer" className="bg-[var(--accent)] text-white px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg hover:scale-105 hover:bg-[var(--accent-opacity)] transition-all duration-300 w-1/3 sm:w-auto self-center">
              Download CV
            </Link>
            <Link href="https://github.com/maxsherman1" target="_blank" rel="noopener noreferrer" className="bg-[var(--secondary-accent)] text-white px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg hover:scale-105 hover:bg-[var(--secondary-accent-opacity)] transition-all duration-300 w-1/3 sm:w-auto self-center">
              GitHub
            </Link>
            <Link href="https://www.linkedin.com/in/maxsherman1/" target="_blank" rel="noopener noreferrer" className="bg-[var(--secondary-accent)] text-white px-6 py-3 rounded-lg font-medium shadow-md hover:shadow-lg hover:scale-105 hover:bg-[var(--secondary-accent-opacity)] transition-all duration-300 w-1/3 sm:w-auto self-center">
              LinkedIn
            </Link>
          </div>
        </div>
